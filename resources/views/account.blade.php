...
<div class="container">
    <div class="profile-header d-flex mt-4  ">
        ...
        <div class="login-user-edit mx-3">
            ...
            <p><a
                    href="#"
                    class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Редактировать</a>
            </p>
        </div>
    </div>
    <div class="buttons-group-filter d-flex border-bottom gap-3 py-4 flex-wrap">
        ...
        <a href="" class="btn btn-custom flex-md-auto">Комментарии</a>
    </div>
